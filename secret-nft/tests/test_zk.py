...
def _test_zk(use_keccak):
    ...
    eve = accounts[2]
    amount = "10 ether"
    print("Setup used", time.time() - start_time)
    ...
    print("Deployment used", time.time() - deploy_time)
    ...
    print("Proving used", time.time() - prove_time)
    ...
    print("Verifying used", time.time() - verify_time)
    ...
    print("Decrypting used", time.time() - decrypt_time)
